...
namespace Rabin_Cryptosystem_Application
{
    public partial class MainForm : Form
    {
        ...
        private void btLoadPrivateKey_Click(object sender, EventArgs e)
        {
            ...
            loadPrivateKey.Filter = "Rabin Private Key File (*.RabinPrivateKey)|*.RabinPrivateKey";
            loadPrivateKey.Title = "Load A Rabin Private Key File";
            ...
            if (loadPrivateKey.FileName != "")
            {
                try
                {
                    ...
                    decryptionPrivatePrime1 = new BigInteger(numberBase, maxSize, false, br);
                    decryptionPrivatePrime2 = new BigInteger(numberBase, maxSize, false, br);
        ...
        private void btSelectDecryptionSource_Click(object sender, EventArgs e)
        {
            ...
            selectDecryptionSource.Filter = "Rabin Encrypted File (*.Rabin)|*.Rabin";
            selectDecryptionSource.Title = "Select A Rabin Encrypted File";
        ...
        private void btStartDecryption_Click(object sender, EventArgs e)
        {
            ...
            decryption = new Decryption(decryptionPublicModulus, decryptionPrivatePrime1,
                                        decryptionPrivatePrime2, bufferSize, shiftDigits, saltDigits, br, bw);
        ...
        private void AutoDeterminePrivateKey()
        {
            ...
            {
                publicKeyFromFile =
                        Decryption.ReadPublicKey(numberBase, maxSize, decryptionSourceFileName);
            }
            ...
            FileInfo[] privateKeyFiles = di.GetFiles("*.RabinPrivateKey");
