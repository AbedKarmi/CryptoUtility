...
namespace RSA_Cryptosystem_Application
{
    public partial class MainForm : Form
    {
        ...
        private void btLoadPublicKey_Click(object sender, EventArgs e)
        {
            ...
            loadPublicKey.Filter = "RSA Public Key File (*.RSAPublicKey)|*.RSAPublicKey";
            loadPublicKey.Title = "Load A RSA Public Key File";
            ...
            if (loadPublicKey.FileName != "")
            {
                try
                {
                    ...
                    encryptionPublicExponent = new BigInteger(numberBase, maxSize, false, br);
        ...
        private void btSelectEncryptionTarget_Click(object sender, EventArgs e)
        {
            ...
            selectEncryptionTarget.Filter = "RSA Encrypted File (*.RSA)|*.RSA";
            selectEncryptionTarget.Title = "Save A RSA Encrypted File As";
            ...
            {
                if (!selectEncryptionTarget.FileName.EndsWith(".RSA"))
                    selectEncryptionTarget.FileName += ".RSA";
        ...
        private void btStartEncryption_Click(object sender, EventArgs e)
        {
            ...
            encryption = new Encryption(encryptionPublicModulus, encryptionPublicExponent, bufferSize, br, bw);
